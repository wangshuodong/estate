...
//	private String mKey = "cfji72jqwtf8";// 打印机密钥
    ...
    public boolean sendContent(String content) {
        try {
            ...
            byte[] data = ("partner=" + partner + "&machine_code=" + machine_code + "&content=" + encodeContent + "&sign="
            ...
            if (conn.getResponseCode() == 200) {
                ...
                JSONObject json = JSONObject.parseObject(sub);
...
//            obj.sendContent("<center>支付宝智慧小区</center>\n" +
//					"小区名称：莫须有小区\n" +
//					"2栋10单元502\n" +
//					"业主姓名：李东\n" +
//					"付款时间：2017-11-27 22:27:18\n" +
//					"订单编号：1011\n" +
//					"支付方式：现金\n" +
//					"缴费金额：100.0\n" +
//					"缴费明细：\n" +
//					"<table><tr><td>类别</td><td>账期</td><td>金额</td></tr><tr><td>现金</td><td>2017年11</td><td>100.0</td></tr></table>\n" +
//					"收款单位：null\n" +
//					"<center>技术支持：早早科技/0571-88683117/www.早早.com</center>\n" +
//					"----------------------\n" +
//					"<center>交易小票</center>");// 打印消息
