    ...
    <form class="form form-horizontal" id="myform" action="" method="post">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text radius size-L" value="${housinginfo.name}" placeholder="小区名称" name="name" disabled>
            </div>
        </div>
        <div class="row cl">
...
<script type="text/javascript">
    $("#myform").validate({
        submitHandler:function(form) {
            $(form).ajaxSubmit({
                type: 'post',
                url: "${pageContext.request.contextPath }/rest/housing/saveOrUpdateSmsdeposit",
